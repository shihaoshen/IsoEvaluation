...
#7th for Flux delta psi H1 5% H0 1%, 21th for t test p values H1 5%, H0 50%
...
true[(abs(true_tmp) > 0.05) & (ttest_tmp < 0.05) & (mean(count1_tmp + count2_tmp)> 10)]=1
...
pdf('rMATS_ISO_FluxDeltaPsi5Ttest05_roc_total10_turboJC_majiq001.pdf')
